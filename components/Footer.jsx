      ...
      <div className="footer-top">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="#servicii">Botez</a></li>
            <li><a href="#servicii">Ateliere creative</a></li>
            <li><a href="#servicii">Ședințe foto</a></li>
          </ul>
        </div>
        <div>
          <h4>Contact</h4>
          <ul>
            <li>Strada Cloșca</li>
            <li>240157 Râmnicu Vâlcea</li>
            <li><a href="tel:0752592893">0752 592 893</a></li>
          </ul>
        </div>
      </div>
